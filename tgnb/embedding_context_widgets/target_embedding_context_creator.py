...
from .target_embedding_context import TargetEmbeddingContextWidget
from tgnb.canonical_dict import CanonicalDict


class TargetEmbeddingContextCreatorWidget(object):
    def __init__(self, vocabs):
        ...
        self._w_ec_name = widgets.Text(
            value="tgt-ec-{}".format(len(self._ecs)),
            description="Name:")
    ...
    def params(self):
        return {
            "__type__": "TargetEmbeddingContextCreatorWidget",
